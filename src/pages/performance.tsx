        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
          ...
          <div className="flex-shrink-0 w-full sm:w-64">
            ...
            <select
              ...
              className="w-full cursor-pointer rounded-md border border-border bg-background px-3 py-2 text-sm text-foreground outline-none transition focus:border-blue-600 focus:ring-2 focus:ring-blue-600/20"
              ...
              {[
                ...
                <div key={item.label}>
                  ...
                  <div className="h-1.5 rounded-full bg-zinc-200">
                    <div className="h-1.5 rounded-full bg-blue-600" style={{ width: `${item.value}%` }} />
                  </div>
                </div>
              ))}
            </div>
